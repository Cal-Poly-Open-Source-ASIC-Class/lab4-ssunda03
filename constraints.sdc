...
create_clock [get_ports i_rclk] -name i_rclk -period 13
...
set_max_delay -from [get_pins rgray*df*/CLK] -to [get_pins wq2_rgray*df*/D] $min_period
set_max_delay -from [get_pins wgray*df*/CLK] -to [get_pins rq2_wgray*df*/D] $min_period